...
classesFiles = '/home/danieletostiPI/ROBOT_ARM_FACE/coco.names'    # extract names from coco.names file
classNames = []
...
while go:
    ...
    outputs = net.forward(outputNames)  # now i convert outputs in the object i want to find : output is a list of 3 elements( 3 outputs)
                                        # spiegato bene nel video YOLO v3 EASY METHOD | OpenCV Python (2020) p.3 di Murtaza's Workshop
